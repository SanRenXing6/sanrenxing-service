...
public class MessageDataAccessService implements MessageDao{
    ...
    public int addMessage(Message message) {
        ...
        String sql = "INSERT into messages(id, from_user_id, from_user_name, to_user, content) VALUES (?, ?, ?, ?, ?);";
    ...
    public List<Message> getMessagesToUser(UUID userId) {
        final String sql = "SELECT id, from_user_id, from_user_name, to_user, content, created_at FROM messages WHERE from_user_id=? OR to_user=? ORDER BY created_at;";
        return jdbcTemplate.query(sql,
                ...
                (resultSet, i) -> {
                    ...
                    return new Message(id, from_user_id, from_user_name, to_user, content, created_at);
                });
    }
